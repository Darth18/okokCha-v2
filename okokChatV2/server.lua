...
local Webhook = 'https://discord.com/api/webhooks/1064756930494603314/5V8hjCdoG5HUfzXSmRwuCP8lUrPuVaSR6n_LwFjPJZYw7hoNfZzJexn_sNL5ARWihnFk' -- PUT YOUR WEBHOOK LINK HERE
...
--[[exports.chat:registerMessageHook(function(source, outMessage, hookRef)
    ...
    local cmd = Split(msg:sub(2), " ")[1]

    if string.sub(msg, 1, 1) ~= "/" or not CheckCommand(cmd) then
        hookRef.cancel()
